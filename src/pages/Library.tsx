...
import { BookOpen, Headphones, ExternalLink, Plus, Loader2 } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="relative aspect-[3/4] overflow-hidden">
        <img
          src={resource.cover_image || (resource.type === 'book_pdf' ? defaultBookCover : defaultPodcastCover)}
          alt={resource.title}
